const aboutProfile = [
  "Senior Network, Security, Cloud & Automation Engineer with over 15 years of experience designing, deploying, and automating secure, scalable, and high-performance IT infrastructures across complex global environments.",
  ...
  "Proven track record in delivering large-scale international network transformation programs, including SD-WAN and SD-Access initiatives, combining technical excellence, strategic vision, and leadership to drive resilient, secure, and future-ready infrastructures."
];
...
export function About() {
  return <section id="about" className="section">
    ...
    <div className="mt-6 space-y-4 card">
      {aboutProfile.map((paragraph) => <p key={paragraph} className="muted leading-relaxed">{paragraph}</p>)}
    </div>
  </section>;
}
