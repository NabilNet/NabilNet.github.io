...
export function Hero() {
  return <section id="home" className="section pt-20">
    <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }} className="card relative overflow-hidden">
      ...
      <h1 className="mt-3 max-w-5xl text-2xl font-semibold leading-tight md:text-4xl">Designing resilient, secure, and scalable Network, Security, Cloud, Automation, Campus, and Data Center infrastructures to support large-scale digital transformation, operational excellence, and modern enterprise services.</h1>
