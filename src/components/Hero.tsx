...
export function Hero() {
  return <section id="home" className="section pt-20">
    <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }} className="card relative overflow-hidden">
      ...
      <p className="muted mt-4 max-w-[680px] text-[0.95rem] leading-[1.5] md:text-[1.08rem]">Consulting-grade infrastructure architecture, modernization, and execution for complex international environments.</p>
