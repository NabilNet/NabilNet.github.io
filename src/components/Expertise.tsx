...
export function Expertise() {
  const safeCategories = Array.isArray(expertiseCategories) ? expertiseCategories : [];
  ...
  return <section id="expertise" className="section">
    ...
    <div className="mt-8 grid gap-4 md:grid-cols-2 xl:grid-cols-3">{safeCategories.map((category) => <article key={category.title} className="card bg-token-surface-elevated p-5">
